...
const loadSearchResults = async function(query) {
    try {
        ...
        console.error(`${err} Searching results lost C 🐶`);
        throw err;
    }
};
...
const updateServings = function(newServings) {
    //goes into state + recipe and changes base ingredient
    state.recipe.ingredients.forEach((ing)=>{
        ing.quantity = ing.quantity * newServings / state.recipe.servings;
    //new quantity = old quant * new Serv / old serving//
    //2 * 8/4 = 4
    //2unit * 3 new/ 6old =1
    });
...
const uploadRecipe = async function(newRecipe) {
    try {
        //converting the input object into an array
        //its opp of entries
        ...
        // console.log(recipe);
        const data = await (0, _helpers.AJAX)(`${(0, _configJs.API_URL_SEND)}?search=${recipe.title}&key=${(0, _configJs.KEY)}`, recipe);
        state.recipe = createRecipeObject(data);
...
},{"./config.js":"k5Hzs","./helpers":"hGI1E","regenerator-runtime":"dXNgZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"k5Hzs":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "API_URL", ()=>API_URL);
parcelHelpers.export(exports, "API_URL_SEND", ()=>API_URL_SEND);
parcelHelpers.export(exports, "TIMEOUT_SEC", ()=>TIMEOUT_SEC);
parcelHelpers.export(exports, "RES_PER_PAGE", ()=>RES_PER_PAGE);
parcelHelpers.export(exports, "KEY", ()=>KEY);
parcelHelpers.export(exports, "MODAL_CLOSE_SEC", ()=>MODAL_CLOSE_SEC);
const API_URL = `https://forkify-api.herokuapp.com/api/v2/recipes/`;
const API_URL_SEND = `https://forkify-api.herokuapp.com/api/v2/recipes`;
const TIMEOUT_SEC = 10;
const RES_PER_PAGE = 10;
const KEY = "f4ccd4c0-04cd-442d-bdea-00c57c1b63c2";
...
class RecipeView extends (0, _viewJsDefault.default) {
  ...
  <div class="recipe__ingredients">
    ...
    ${this._data.ingredients.map(this._generateMarkupIngredients)//       return `<li class="recipe__ingredient">
...
class PaginationView extends (0, _viewJsDefault.default) {
    ...
    addHandlerClick(handler) {
        this._parentElement.addEventListener("click", function(e) {
            const btn = e.target.closest(".btn--inline"); // insert class btn--inline
            if (!btn) return;
...
class BookmarksView extends (0, _viewJsDefault.default) {
    ...
    //so for eacgh of thge bookmarks, we want to render a preview
    //must be a string, to insert as HTML
    }
}
